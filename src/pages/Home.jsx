...
const Landing = () => {
  ...
  return (
    <div className="pb-10 max-w-screen text-white scrollbar">
      ...
      <div className="pt-[150px] mb-24 md:mb-48 lg:mb-[352px] text-main relative">
      ...
      <section className="card-section mx-6 md:mx-12 lg:mx-24 z-0 rounded-md p-4 md:p-7 lg:p-12 relative overflow-hidden">
        <div className="z-10">
