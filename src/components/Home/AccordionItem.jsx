  ...
  return (
    <div className="rounded-lg border border-gray-500 p-4 lg:p-6 bg-main/5">
      <div
        ...
        <Plus className={`size-5 transition-transform duration-300 transform mb-px flex-shrink-0 ${opened ? "rotate-45" : "rotate-0"}`} />
      </div>
      <div className={`overflow-hidden grid transition-all duration-300 ease-in-out ${opened ? "grid-rows-[1fr] opacity-100 pt-3" : "grid-rows-[0fr] opacity-0 p-0"}`}>
